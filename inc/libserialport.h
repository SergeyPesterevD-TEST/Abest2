 ...
 * @since 0.1.0
 */
SP_API SP_API enum sp_return sp_open(struct sp_port *port, enum sp_mode flags);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_set_parity(struct sp_port *port, SP_API enum sp_parity parity);

/**
 * Get the parity setting from a port configuration.
 *
 * The user should allocate a variable of type SP_API enum sp_parity and
 * pass a pointer to this to receive the result.
 *
 * @param[in] config Pointer to a configuration structure. Must not be NULL.
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_get_config_parity(const struct sp_port_config *config, SP_API enum sp_parity *parity_ptr);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_set_config_parity(struct sp_port_config *config, SP_API enum sp_parity parity);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_set_rts(struct sp_port *port, SP_API enum sp_rts rts);

/**
 * Get the RTS pin behaviour from a port configuration.
 *
 * The user should allocate a variable of type SP_API enum sp_rts and
 * pass a pointer to this to receive the result.
 *
 * @param[in] config Pointer to a configuration structure. Must not be NULL.
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_get_config_rts(const struct sp_port_config *config, SP_API enum sp_rts *rts_ptr);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_set_config_rts(struct sp_port_config *config, SP_API enum sp_rts rts);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_set_cts(struct sp_port *port, SP_API enum sp_cts cts);

/**
 * Get the CTS pin behaviour from a port configuration.
 *
 * The user should allocate a variable of type SP_API enum sp_cts and
 * pass a pointer to this to receive the result.
 *
 * @param[in] config Pointer to a configuration structure. Must not be NULL.
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_get_config_cts(const struct sp_port_config *config, SP_API enum sp_cts *cts_ptr);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_set_config_cts(struct sp_port_config *config, SP_API enum sp_cts cts);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_set_dtr(struct sp_port *port, SP_API enum sp_dtr dtr);

/**
 * Get the DTR pin behaviour from a port configuration.
 *
 * The user should allocate a variable of type SP_API enum sp_dtr and
 * pass a pointer to this to receive the result.
 *
 * @param[in] config Pointer to a configuration structure. Must not be NULL.
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_get_config_dtr(const struct sp_port_config *config, SP_API enum sp_dtr *dtr_ptr);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_set_config_dtr(struct sp_port_config *config, SP_API enum sp_dtr dtr);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_set_dsr(struct sp_port *port, SP_API enum sp_dsr dsr);

/**
 * Get the DSR pin behaviour from a port configuration.
 *
 * The user should allocate a variable of type SP_API enum sp_dsr and
 * pass a pointer to this to receive the result.
 *
 * @param[in] config Pointer to a configuration structure. Must not be NULL.
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_get_config_dsr(const struct sp_port_config *config, SP_API enum sp_dsr *dsr_ptr);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_set_config_dsr(struct sp_port_config *config, SP_API enum sp_dsr dsr);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_set_xon_xoff(struct sp_port *port, SP_API enum sp_xonxoff xon_xoff);

/**
 * Get the XON/XOFF configuration from a port configuration.
 *
 * The user should allocate a variable of type SP_API enum sp_xonxoff and
 * pass a pointer to this to receive the result.
 *
 * @param[in] config Pointer to a configuration structure. Must not be NULL.
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_get_config_xon_xoff(const struct sp_port_config *config, SP_API enum sp_xonxoff *xon_xoff_ptr);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_set_config_xon_xoff(struct sp_port_config *config, SP_API enum sp_xonxoff xon_xoff);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_set_config_flowcontrol(struct sp_port_config *config, SP_API enum sp_flowcontrol flowcontrol);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_set_flowcontrol(struct sp_port *port, SP_API enum sp_flowcontrol flowcontrol);
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_flush(struct sp_port *port, SP_API enum sp_buffer buffers);
...
SP_API enum sp_return sp_add_port_events(struct sp_event_set *event_set,
	const struct sp_port *port, SP_API enum sp_event mask);
 ...
 *
 * The user should allocate a variable of type "SP_API enum sp_signal" and pass a
 ...
 * @since 0.1.0
 */
SP_API enum sp_return sp_get_signals(struct sp_port *port, SP_API enum sp_signal *signal_mask);
